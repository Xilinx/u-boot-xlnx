...
static unsigned long psu_clock_init_data(void)
{
	...
	psu_mask_write(0xFF180360, 0x0000000CU, 0x00000004U);
	psu_mask_write(0xFF180308, 0x000000C0U, 0x000000C0U);
...
static unsigned long psu_mio_init_data(void)
{
	...
	psu_mask_write(0xFF180108, 0x000000FEU, 0x00000040U);
	psu_mask_write(0xFF18010C, 0x000000FEU, 0x00000040U);
	psu_mask_write(0xFF180118, 0x000000FEU, 0x000000C0U);
	psu_mask_write(0xFF18011C, 0x000000FEU, 0x000000C0U);
	psu_mask_write(0xFF180204, 0x87FFFFFFU, 0x84000000U);
	psu_mask_write(0xFF180208, 0xFFFC183CU, 0x00B00020U);
	psu_mask_write(0xFF18020C, 0x000000CCU, 0x00000040U);
...
static unsigned long psu_serdes_init_data(void)
{
	...
	psu_mask_write(0xFD405990, 0x000000FFU, 0x00000000U);
	psu_mask_write(0xFD405924, 0x000000FFU, 0x00000082U);
	...
	psu_mask_write(0xFD405914, 0x000000FFU, 0x000000FFU);
	psu_mask_write(0xFD405918, 0x00000001U, 0x00000001U);
	psu_mask_write(0xFD405940, 0x000000FFU, 0x000000FFU);
	...
	serdes_illcalib(0, 0, 3, 0, 5, 0, 0, 0);
	psu_mask_write(0xFD410010, 0x00000070U, 0x00000050U);
