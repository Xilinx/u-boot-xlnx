...
const struct flash_info spi_nor_ids[] = {
	...
	SPI_NOR_QUAD_READ | SPI_NOR_HAS_LOCK | SPI_NOR_4B_OPCODES)},
	{
		INFO("gd25lx256e", 0xc86819, 0, 64 * 1024, 512,
		     ...
		     SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB | SPI_NOR_OCTAL_DTR_READ | SPI_NOR_OCTAL_DTR_PP)
	},
	...
	{ INFO("mx25um51345g",   0xc2813a, 0, 64 * 1024, 1024,
				 SECT_4K | SPI_NOR_4B_OPCODES | SPI_NOR_OCTAL_READ | SPI_NOR_OCTAL_DTR_READ | SPI_NOR_OCTAL_DTR_PP) },
	...
	{ INFO("mt35xu02g",  0x2c5b1c, 0, 128 * 1024,  2048,
		USE_FSR | SPI_NOR_OCTAL_READ | SPI_NOR_4B_OPCODES | SPI_NOR_OCTAL_DTR_READ | SPI_NOR_OCTAL_DTR_PP | NO_CHIP_ERASE) },
	...
	{ INFO("s28hs02gt",  0x345b1c,      0, 256 * 1024, 1024, SPI_NOR_4B_OPCODES | SPI_NOR_MULTI_DIE | NO_CHIP_ERASE) },
#endif
#endif
